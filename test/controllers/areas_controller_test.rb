...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { sq_ft: @area.sq_ft, status: @area.status, suite_number: @area.suite_number } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { sq_ft: @area.sq_ft, status: @area.status, suite_number: @area.suite_number } }
